...
if ( ! function_exists('admin_listnum_selectbox')) {
	function admin_listnum_selectbox()
	{
		...
		$html = '<div class="input-group mb-3"><select name="listnum" class="form-select" onchange="location.href=\'' . current_url() . '?listnum=\' + this.value;">';
		...
		$html .= '</select><label class="input-group-text">개씩 보기</label></div>';
