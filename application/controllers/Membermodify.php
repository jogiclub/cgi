				...
				foreach ($form as $key => $value) {
					...
					if (element('field_type', $value) === 'text'
						...
						$html_content[$k]['input'] .= '
							...
							<label>
								<button type="button" class="btn btn-dark btn-sm" style="margin-top:0px;" onclick="win_zip(\'fregisterform\', \'mem_zipcode\', \'mem_address1\', \'mem_address2\', \'mem_address3\', \'mem_address4\');">주소 검색</button>
							</label>
