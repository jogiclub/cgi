...
$config['email_protocol'] = 'smtp'; // mail/sendmail/smtp
$config['email_smtp_host'] = 'smtp.gmail.com';
$config['email_smtp_user'] = 'jogiclub@52ch.kr';
$config['email_smtp_pass'] = 'vyzm sqjo ksqg ysun';
...
$config['email_protocol'] = 'smtp'; // mail/sendmail/smtp
$config['email_smtp_host'] = 'smtp.gmail.com';
$config['email_smtp_user'] = 'praise7070@hanmail.net';
$config['email_smtp_pass'] = 'zdlt driw epud yoym';
$config['email_smtp_port'] = '587';
$config['email_smtp_crypto'] = 'tls'; // SMTP Encryption. Can be null, tls or ssl.
*/
