	...
	<div class="panel panel-default">
		<div class="panel-body">
            ...
            <div class="form-floating mb-3">
                <input type="text" class="form-control" id="mem_userid" name="mem_userid" value="<?php echo set_value('mem_userid'); ?>" accesskey="L">
                <label for="mem_userid"><?php echo element('userid_label_text', $view);?></label>
            </div>
            <div class="form-floating">
                <input type="password" class="form-control" id="mem_password" placeholder="mem_password">
            ...
            <div class="col-md-12 d-grid">
                    ...
                    <label for="autologin"><input type="checkbox" name="autologin" id="autologin" value="1" /> 자동로그인</label>
			...
			?>
				<div class="input-group mt30 form-horizontal">
			...
			<?php } ?>
				...
				<a href="<?php echo site_url('register'); ?>" class="btn btn-success  mt-3" title="회원가입">회원가입</a>
				<a href="<?php echo site_url('findaccount'); ?>" class="btn btn-secondary  mt-1" title="아이디 패스워드 찾기">아이디 패스워드 찾기</a>
            </div>
