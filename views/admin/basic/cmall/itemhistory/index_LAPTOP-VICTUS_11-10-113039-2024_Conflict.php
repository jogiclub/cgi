	...
	<div class="box-table">
		<div class="box-table-header">
			<ul class="nav nav-tabs mb-3">
				<li class="nav-item"><a class="nav-link active" href="<?php echo admin_url($this->pagedir); ?>">상품내용변경로그</a></li>
				...
				<table class="table table-hover table-striped table-bordered">
					...
					?>
						<tr>
							...
							<td><a href="?sfield=cmall_item_history.cit_id&amp;skeyword=<?php echo element('cit_id', $result); ?>"><?php echo html_escape(element('chi_title', $result)); ?></a> <a href="<?php echo goto_url(element('itemurl', $result)); ?>" target="_blank"><span class="bi bi-external-link"></span></a></td>
