			...
			?>
				<div class="box-table-header">
					<ul class="nav nav-tabs mb-3">
						<li class="nav-item"><a class="nav-link active" href="<?php echo admin_url($this->pagedir); ?>">게시물변경로그</a></li>
					...
					<table class="table table-hover table-striped table-bordered">
						...
						?>
							<tr>
								...
								<td><a href="?sfield=post_history.post_id&amp;skeyword=<?php echo element('post_id', $result); ?>"><?php echo html_escape(element('phi_title', $result)); ?></a> <a href="<?php echo goto_url(element('posturl', $result)); ?>" target="_blank"><span class="bi bi-external-link"></span></a></td>
