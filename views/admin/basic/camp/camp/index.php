		...
		?>
			<div class="box-table-header">
				...
				<div class="btn-group btn-group-sm pull-right" role="group">
					<a href="?" class="btn btn-sm <?php echo ($this->input->get('ban_activated') !== 'Y' && $this->input->get('ban_activated') !== 'N') ? 'btn-success' : 'btn-secondary'; ?>">전체배너</a>
					<a href="?ban_activated=Y" class="btn btn-sm <?php echo ($this->input->get('ban_activated') === 'Y') ? 'btn-success' : 'btn-secondary'; ?>">활성</a>
					<a href="?ban_activated=N" class="btn btn-sm <?php echo ($this->input->get('ban_activated') === 'N') ? 'btn-success' : 'btn-secondary'; ?>">비활성</a>
				</div>
			</div>
