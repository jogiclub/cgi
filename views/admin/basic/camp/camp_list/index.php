    ...
    <div class="box-table">
        ...
        <div class="box-table-header">
            <div class="btn-group btn-group-sm" role="group">
                <a href="?ch_close=N" class="btn <?php echo ($this->input->get('ch_close') === 'N') ? 'btn-success' : 'btn-default'; ?>">진행중</a>
                <a href="?ch_close=Y" class="btn <?php echo ($this->input->get('ch_close') === 'Y') ? 'btn-success' : 'btn-default'; ?>">마감</a>
            </div>
            <?php
            ob_start();
            ?>
            <div class="btn-group pull-right" role="group" aria-label="...">
                <a href="<?php echo element('write_url', $view); ?>" class="btn btn-outline btn-danger btn-sm">캠프등록</a>
            </div>
            <?php
        ...
        <div class="table-responsive">
            <table class="table table-hover table-striped table-bordered">
                ...
                <tr>
                    ...
                    <th>참가비</th>
                    <th>신청현황</th>
                    <th><a href="<?php echo element('icon', element('sort', $view)); ?>">상태</a></th>
                    <th>관리</th>
                ...
                if (element('list', element('data', $view))) {
                    foreach (element('list', element('data', $view)) as $result) {
                        ...
                        <tr>
                            ...
                            <td class="text-right"><?php echo number_format(element('ch_pay', $result)); ?>원</td>
                            <td class="text-center">
                                <a href="<?php echo admin_url('camp/apply/index/' . element(element('primary_key', $view), $result)); ?>">
                                    <?php
                            ...
                            <td>
                                <a href="<?php echo admin_url($this->pagedir); ?>/camp/camp_list/write/<?php echo element(element('primary_key', $view), $result); ?>?<?php echo $this->input->server('QUERY_STRING', null, ''); ?>" class="btn btn-default btn-sm">수정</a>
