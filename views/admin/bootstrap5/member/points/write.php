<div class="box">
	<div class="box-table">
		...
		<div class="box-table-header">
			...
			<a data-toggle="collapse" href="#collapse1" aria-expanded="true" aria-controls="collapse1"><i class="bi bi-chevron-up pull-right"></i></a>
		</div>
		<div class="collapse in" id="collapse1">
			...
			?>
				...
				<div class="col-md-6"><div class="btn-group pull-right" role="group" aria-label="...">
					<button type="submit" class="btn btn-outline btn-success ">특정회원 포인트 추가하기</button>
				</div>
			<?php echo form_close(); ?>
		</div>
	</div>
	<div class="box-table">
		<div class="box-table-header">
			...
			<a data-toggle="collapse" href="#collapse2" aria-expanded="true" aria-controls="collapse2"><i class="bi bi-chevron-up pull-right"></i></a>
		</div>
		<div class="collapse in" id="collapse2">
			...
			?>
				...
				<div class="col-md-6"><div class="btn-group pull-right" role="group" aria-label="...">
					<button type="submit" class="btn btn-outline btn-success ">모든 회원 포인트 동시 추가</button>
				</div>
			<?php echo form_close(); ?>
		</div>
	</div>
