	...
	<div class="box-table">
		<div class="box-table-header">
			<ul class="nav nav-tabs mb-3">
				<li class="nav-item"><a class="nav-link" href="<?php echo admin_url($this->pagedir); ?>">포인트 목록</a></li>
				<li class="nav-item"><a class="nav-link active" href="<?php echo admin_url($this->pagedir . '/cleanlog'); ?>">포인트 로그 정리</a></li>
			</ul>
		</div>
		<?php
		...
		<div class="box-info">
			...
			?>
				...
				<div class="box-button btn-group">
					<button type="submit" class="btn btn-success ">정리하기</button>
				</div>
			<?php
				echo form_close();
			}
