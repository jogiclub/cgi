		...
		?>
			<div class="box-table-header">
				<ul class="nav nav-tabs mb-3">
					<li class="nav-item"><a class="nav-link active" href="<?php echo admin_url($this->pagedir); ?>">포인트 목록</a></li>
					<li class="nav-item"><a class="nav-link" href="<?php echo admin_url($this->pagedir . '/cleanlog'); ?>">포인트 로그 정리</a></li>
				</ul>
				<?php
				ob_start();
				?>
					<div class="col-md-6"><div class="btn-group pull-right" role="group" aria-label="...">
						...
						<a href="<?php echo element('write_url', $view); ?>" class="btn btn-outline btn-danger ">포인트추가</a>
					</div>
				<?php
