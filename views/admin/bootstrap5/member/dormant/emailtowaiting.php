<div class="box">
	<div class="box-header">
		<ul class="nav nav-tabs mb-3">
			...
			<li class="nav-item"><a class="nav-link active" href="<?php echo admin_url($this->pagedir . '/emailtowaiting'); ?>">안내메일일괄발송</a></li>
	...
	<div class="box-table">
		...
		<div class="box-info">
			<div class="box-button btn-group">
				<button type="button" class="btn btn-success  execute_clean">메일발송하기</button>
			</div>
		</div>
	</div>
</div>
