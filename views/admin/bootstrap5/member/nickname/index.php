		...
		?>
			<div class="box-table-header">
				<div class="btn-group btn-group-sm" role="group">
					<a href="?" class="btn  <?php echo ($this->input->get('use') !== 'Y' && $this->input->get('use') !== 'N') ? 'btn-success' : 'btn-secondary'; ?>">전체닉네임</a>
					<a href="?use=Y" class="btn  <?php echo ($this->input->get('use') === 'Y') ? 'btn-success' : 'btn-secondary'; ?>">현재사용중인닉네임</a>
					<a href="?use=N" class="btn  <?php echo ($this->input->get('use') === 'N') ? 'btn-success' : 'btn-secondary'; ?>">사용종료된닉네임</a>
				</div>
				<?php
				ob_start();
				?>
