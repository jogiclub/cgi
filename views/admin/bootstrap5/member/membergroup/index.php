		...
		?>
			...
			<div class="box-table-header">
				<div class="col-md-6"><div class="btn-group pull-right" role="group" aria-label="...">
					<button type="submit" class="btn btn-outline btn-danger ">저장하기</button>
				</div>
			</div>
			...
			<div class="list-group">
				...
				<div id="sortable">
					...
					?>
						<div class="input-group list-group-item">
							<div class="col-sm-1"><div class="bi bi-arrows" style="cursor:pointer;"></div><input type="hidden" name="mgr_id[<?php echo element('mgr_id', $result); ?>]" value="<?php echo element('mgr_id', $result); ?>" /></div>
