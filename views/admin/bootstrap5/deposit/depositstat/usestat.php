<div class="box">
	<div class="box-header">
		<ul class="nav nav-tabs mb-3">
			<li class="nav-item"><a class="nav-link" href="<?php echo admin_url($this->pagedir); ?>">충전통계</a></li>
			<li class="nav-item"><a class="nav-link active" href="<?php echo admin_url($this->pagedir . '/usestat'); ?>">사용통계</a></li>
		...
		<div class="box-table-header">
			<form class="form-inline" name="flist" action="<?php echo current_url(); ?>" method="get" >
				...
				<div class="col-sm-6">
					...
					<button type="button" class="btn <?php echo ($this->input->get('dep_to_type') !== 'contents' && $this->input->get('dep_to_type') !== 'point' && $this->input->get('dep_to_type') !== 'cash') ? 'btn-success' : 'btn-secondary'; ?> " onclick="fcharge_submit('');">전체</button>
					<button type="button" class="btn <?php echo ($this->input->get('dep_to_type') === 'contents') ? 'btn-success' : 'btn-secondary'; ?> " onclick="fcharge_submit('contents');">컨텐츠구매</button>
					<button type="button" class="btn <?php echo ($this->input->get('dep_to_type') === 'point') ? 'btn-success' : 'btn-secondary'; ?> " onclick="fcharge_submit('point');">포인트로전환</button>
				</div>
				<div class="row">
					                      <div class="col-sm-6">
