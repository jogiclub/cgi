<div class="box">
	<div class="box-header">
		<ul class="nav nav-tabs mb-3">
			...
			<li class="nav-item"><a class="nav-link active" href="<?php echo admin_url($this->pagedir . '/memberstat'); ?>">회원별 구매회수</a></li>
		...
		<div class="box-table-header">
			<form class="form-inline" name="flist" action="<?php echo current_url(); ?>" method="get" >
				...
				<div class="col-sm-6">
					...
					<button type="button" class="btn <?php echo ($this->input->get('orderby') !== 'deposit') ? 'btn-success' : 'btn-secondary'; ?> " onclick="forder_submit('');">결제회수순</button>
					<button type="button" class="btn <?php echo ($this->input->get('orderby') === 'deposit') ? 'btn-success' : 'btn-secondary'; ?> " onclick="forder_submit('deposit');">적립<?php echo html_escape($this->cbconfig->item('deposit_name')); ?>순</button>
				</div>
				<div class="row">
