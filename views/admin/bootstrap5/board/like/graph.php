	...
	<div class="box-table">
		<div class="box-table-header">
			<ul class="nav nav-tabs mb-3">
				<li class="nav-item"><a class="nav-link" href="<?php echo admin_url($this->pagedir); ?>">목록</a></li>
				<li class="nav-item"><a class="nav-link active" href="<?php echo admin_url($this->pagedir . '/graph'); ?>">추천 그래프</a></li>
				<li class="nav-item"><a class="nav-link" href="<?php echo admin_url($this->pagedir . '/graph_dislike'); ?>">비추 그래프 </a></li>
			</ul>
			<form class="form-inline" name="flist" action="<?php echo current_url(); ?>" method="get" >
				...
				<div class="row">
					<?php if (element('boardlist', $view)) { ?>
						<div class="col-sm-6">
							<select name="brd_id" class="form-select">
