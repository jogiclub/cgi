		...
		?>
			<div class="box-table-header">
				<ul class="nav nav-tabs mb-3">
					<li class="nav-item"><a class="nav-link active" href="<?php echo admin_url('board/trash'); ?>">원글 </a></li>
					<li class="nav-item"><a class="nav-link" href="<?php echo admin_url('board/trash_comment'); ?>">댓글 </a></li>
				</ul>
				<?php
				ob_start();
				?>
