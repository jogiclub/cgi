	...
	?>
		<div class="box-header">
			...
			<ul class="nav nav-tabs mb-3">
				<li class="nav-item"><a class="nav-link" href="<?php echo admin_url($this->pagedir . '/write/' . element('bgr_id', element('data', $view))); ?>">기본정보</a></li>
				<li class="nav-item"><a class="nav-link active" href="<?php echo admin_url($this->pagedir . '/write_admin/' . element('bgr_id', element('data', $view))); ?>">그룹관리자</a></li>
			</ul>
		</div>
	<?php
	}
