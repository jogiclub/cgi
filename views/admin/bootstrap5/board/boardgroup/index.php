			...
			<div class="box-table-header">
				...
				?>
					<div class="col-md-6"><div class="btn-group pull-right" role="group" aria-label="...">
						...
						<a href="<?php echo element('write_url', $view); ?>" class="btn btn-outline btn-danger ">그룹추가</a>
					</div>
				<?php
					...
					?>
						<tr>
							...
							<td class=" input-group-sm">
								<select class="form-select" name="group_layout[<?php echo element(element('primary_key', $view), $result); ?>]" >
									<?php echo element('group_layout_option', $result); ?>
								</select>
								<br />
								<select class="form-select" name="group_sidebar[<?php echo element(element('primary_key', $view), $result); ?>]">
								...
								<br />
								<select class="form-select" name="group_skin[<?php echo element(element('primary_key', $view), $result); ?>]" >
									<?php echo element('group_skin_option', $result); ?>
								</select>
							</td>
							<td class=" input-group-sm">
								<select class="form-select" name="group_mobile_layout[<?php echo element(element('primary_key', $view), $result); ?>]" >
									<?php echo element('group_mobile_layout_option', $result); ?>
								</select>
								<br />
								<select class="form-select" name="group_mobile_sidebar[<?php echo element(element('primary_key', $view), $result); ?>]">
									<option value="">기본설정따름</option>
								...
								<br />
								<select class="form-select" name="group_mobile_skin[<?php echo element(element('primary_key', $view), $result); ?>]" >
