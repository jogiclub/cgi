	...
	?>
		<div class="box-header">
			...
			<ul class="nav nav-tabs mb-3">
				<li class="nav-item"><a class="nav-link active" href="<?php echo admin_url($this->pagedir . '/write/' . element('bgr_id', element('data', $view))); ?>" onclick="return check_form_changed();">기본정보</a></li>
				<li class="nav-item"><a class="nav-link" href="<?php echo admin_url($this->pagedir . '/write_admin/' . element('bgr_id', element('data', $view))); ?>" onclick="return check_form_changed();">그룹관리자</a></li>
			</ul>
		</div>
	<?php
	} else {
	?>
		<div class="box-header">
			<ul class="nav nav-tabs mb-3">
				...
				<li class="nav-item"><a class="nav-link" href="javascript:;" onClick="alert('기본정보를 저장하신 후에 다른 정보 수정이 가능합니다');">그룹관리자</a></li>
			</ul>
		</div>
	<?php
	}
		...
		?>
			...
			<div class="input-group">
				...
				<div class="col-sm-10 form-inline">
					...
					사이드바 -
					<select class="form-select" name="group_sidebar" id="group_sidebar">
			...
			<div class="input-group">
				...
				<div class="col-sm-10 form-inline">
					...
					사이드바 -
					<select class="form-select" name="group_mobile_idebar" id="group_mobile_idebar">
						<option value="">기본설정따름</option>
