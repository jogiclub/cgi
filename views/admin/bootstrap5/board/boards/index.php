			...
			<div class="box-table-header">
				...
				?>
					<div class="col-md-6"><div class="btn-group pull-right" role="group" aria-label="...">
						...
						<a href="<?php echo element('write_url', $view); ?>" class="btn btn-outline btn-danger ">게시판추가</a>
					</div>
				<?php
				...
				<table class="table table-hover table-striped table-bordered">
					...
					?>
						<tr>
							...
							<td>
								<select class="form-select" name="bgr_id[<?php echo element(element('primary_key', $view), $result); ?>]" >
									<?php echo element('group_option', $result); ?>
								</select>
							</td>
							<td class=" input-group-sm">
								<select class="form-select" name="board_layout[<?php echo element(element('primary_key', $view), $result); ?>]" >
									<?php echo element('board_layout_option', $result); ?>
								</select>
								<br />
								<select class="form-select" name="board_sidebar[<?php echo element(element('primary_key', $view), $result); ?>]">
								...
								<br />
								<select class="form-select" name="board_skin[<?php echo element(element('primary_key', $view), $result); ?>]" >
									<?php echo element('board_skin_option', $result); ?>
								</select>
							</td>
							<td class=" input-group-sm">
								<select class="form-select" name="board_mobile_layout[<?php echo element(element('primary_key', $view), $result); ?>]" >
									<?php echo element('board_mobile_layout_option', $result); ?>
								</select>
								<br />
								<select class="form-select" name="board_mobile_sidebar[<?php echo element(element('primary_key', $view), $result); ?>]">
									<option value="">기본설정따름</option>
								...
								<br />
								<select class="form-select" name="board_mobile_skin[<?php echo element(element('primary_key', $view), $result); ?>]" >
