<div class="box">
	<div class="box-header">
		...
		<div class="pull-right">
			<select name="brd_id" class="form-select" onChange="location.href='<?php echo admin_url($this->pagedir . '/write_extravars'); ?>/' + this.value;">
		...
		<ul class="nav nav-tabs mb-3">
			<li class="nav-item"><a class="nav-link" href="<?php echo admin_url($this->pagedir . '/write/' . element('brd_id', element('data', $view))); ?>" onclick="return check_form_changed();">기본정보</a></li>
			...
			<li class="nav-item"><a class="nav-link active" href="<?php echo admin_url($this->pagedir . '/write_extravars/' . element('brd_id', element('data', $view))); ?>" onclick="return check_form_changed();">사용자정의</a></li>
			...
			<div class="list-group">
				...
				<div id="sortable">
					...
					?>
						<div class="input-group list-group-item">
							<div class="col-sm-2">
								<div class="bi bi-arrows" style="cursor:pointer;"></div><input type="hidden" name="key[<?php echo $key; ?>]" value="<?php echo $key; ?>" />
							</div>
							<div class="col-sm-2">
								<?php echo $key; ?>
							...
							<div class="col-sm-2"><button type="button" class="btn btn-outline btn-secondary btn-xs btn-delete-row" >삭제</button></div>
						</div>
					<?php
						}
					}
