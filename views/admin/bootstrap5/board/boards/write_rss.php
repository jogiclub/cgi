<div class="box">
	<div class="box-header">
		...
		<div class="pull-right">
			<select name="brd_id" class="form-select" onChange="location.href='<?php echo admin_url($this->pagedir . '/write_rss'); ?>/' + this.value;">
		...
		<ul class="nav nav-tabs mb-3">
			...
			<li class="nav-item"><a class="nav-link active" href="<?php echo admin_url($this->pagedir . '/write_rss/' . element('brd_id', element('data', $view))); ?>" onclick="return check_form_changed();">RSS/사이트맵 설정</a></li>
