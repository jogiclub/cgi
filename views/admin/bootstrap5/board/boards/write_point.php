<div class="box">
	<div class="box-header">
		...
		<div class="pull-right">
			<select name="brd_id" class="form-select" onChange="location.href='<?php echo admin_url($this->pagedir . '/write_point'); ?>/' + this.value;">
		...
		<ul class="nav nav-tabs mb-3">
			...
			<li class="nav-item"><a class="nav-link active" href="<?php echo admin_url($this->pagedir . '/write_point/' . element('brd_id', element('data', $view))); ?>" onclick="return check_form_changed();">포인트기능</a></li>
