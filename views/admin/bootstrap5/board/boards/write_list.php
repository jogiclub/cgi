<div class="box">
	<div class="box-header">
		...
		<div class="pull-right">
			<select name="brd_id" class="form-select" onChange="location.href='<?php echo admin_url($this->pagedir . '/write_list'); ?>/' + this.value;">
		...
		<ul class="nav nav-tabs mb-3">
			...
			<li class="nav-item"><a class="nav-link active" href="<?php echo admin_url($this->pagedir . '/write_list/' . element('brd_id', element('data', $view))); ?>" onclick="return check_form_changed();">목록페이지</a></li>
	...
	<div class="box-table">
		...
		?>
			...
			<div class="box-table-header">
				...
				<a data-toggle="collapse" href="#boardtab1" aria-expanded="true" aria-controls="boardtab1"><i class="bi bi-chevron-up pull-right"></i></a>
			</div>
			...
			<div class="box-table">
				<div class="box-table-header">
					...
					<a data-toggle="collapse" href="#boardtab2" aria-expanded="true" aria-controls="boardtab2"><i class="bi bi-chevron-up pull-right"></i></a>
				</div>
