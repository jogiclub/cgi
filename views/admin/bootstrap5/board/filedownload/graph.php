	...
	<div class="box-table">
		<div class="box-table-header">
			<ul class="nav nav-tabs mb-3">
				<li class="nav-item"><a class="nav-link" href="<?php echo admin_url($this->pagedir); ?>">파일다운로드</a></li>
				<li class="nav-item"><a class="nav-link active" href="<?php echo admin_url($this->pagedir . '/graph'); ?>">기간별 그래프</a></li>
