			...
			<div class="box-table-header">
				...
				?>
					<div class="col-md-6"><div class="btn-group pull-right" role="group" aria-label="...">
						...
						<button type="button" class="btn btn-outline btn-default  btn-list-trash btn-list-selected disabled" data-list-trash-url = "<?php echo element('list_trash_url', $view); ?>" >휴지통</button>
				...
				<table class="table table-hover table-striped table-bordered">
					...
					?>
						<tr>
							...
							<td><a href="?sfield=comment.post_id&amp;skeyword=<?php echo element('post_id', $result); ?>"><?php echo html_escape(element('post_title', $result)); ?></a> <a href="<?php echo goto_url(element('posturl', $result)); ?>" target="_blank"><span class="bi bi-external-link"></span></a></td>
