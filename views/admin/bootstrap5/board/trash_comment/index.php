		...
		?>
			<div class="box-table-header">
				<ul class="nav nav-tabs mb-3">
					<li class="nav-item"><a class="nav-link" href="<?php echo admin_url('board/trash'); ?>">원글 </a></li>
					<li class="nav-item"><a class="nav-link active" href="<?php echo admin_url('board/trash_comment'); ?>">댓글 </a></li>
				</ul>
				<?php
				ob_start();
				?>
					<div class="col-md-6"><div class="btn-group pull-right" role="group" aria-label="...">
						...
						<button type="button" class="btn btn-outline btn-secondary  btn-list-truncate" data-list-truncate-url = "<?php echo element('list_truncate_url', $view); ?>" >휴지통비우기</button>
						...
						<button type="button" class="btn btn-outline btn-secondary  btn-list-recover btn-list-selected disabled" data-list-recover-url = "<?php echo element('list_recover_url', $view); ?>" >복원하기</button>
					</div></div>
				<?php
