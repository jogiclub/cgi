<div class="box">
	<div class="box-header">
		<ul class="nav nav-tabs mb-3">
			<li class="nav-item"><a class="nav-link active" href="<?php echo admin_url($this->pagedir); ?>" onclick="return check_form_changed();">설문조사모음</a></li>
			<li class="nav-item"><a class="nav-link" href="<?php echo admin_url($this->pagedir . '/boards'); ?>" onclick="return check_form_changed();">게시판별사용여부</a></li>
		</ul>
	</div>
	<div class="box-table">
		<?php
		...
		?>
			...
			<div class="input-group">
				...
				<div class="col-sm-10">
					...
					<label class=" form-inline" style="padding-top:7px;padding-left:10px;"><span class="bi bi-bar-chart"></span>
			...
			<div class="input-group">
				...
				<div class="col-sm-10 form-inline">
					...
					사이드바 -
					<select class="form-select" name="sidebar_poll" id="sidebar_poll">
			...
			<div class="input-group">
				...
				<div class="col-sm-10 form-inline">
					...
					사이드바 -
					<select class="form-select" name="mobile_sidebar_poll" id="mobile_sidebar_poll">
						<option value="">기본설정따름</option>
