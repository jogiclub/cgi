<div class="box">
	<div class="box-header">
		<ul class="nav nav-tabs mb-3">
			<li class="nav-item"><a class="nav-link active" href="<?php echo admin_url($this->pagedir); ?>" onclick="return check_form_changed();">일반기능</a></li>
			<li class="nav-item"><a class="nav-link" href="<?php echo admin_url($this->pagedir . '/points'); ?>" onclick="return check_form_changed();">시간/포인트설정</a></li>
			<li class="nav-item"><a class="nav-link" href="<?php echo admin_url($this->pagedir . '/cleanlog'); ?>" onclick="return check_form_changed();">오래된 로그삭제</a></li>
		</ul>
	</div>
	<div class="box-table">
		<?php
		...
		?>
			...
			<div class="input-group">
				...
				<div class="col-sm-10">
					...
					<label class=" form-inline" style="padding-top:7px;padding-left:10px;"><span class="bi bi-trophy"></span>
			...
			<div class="input-group">
				...
				<div class="col-sm-10 form-inline">
					<select class="form-select" name="attendance_order" id="attendance_order">
			...
			<div class="input-group">
				...
				<div class="col-sm-10 form-inline">
					...
					사이드바 -
					<select class="form-select" name="sidebar_attendance" id="sidebar_attendance">
			...
			<div class="input-group">
				...
				<div class="col-sm-10 form-inline">
					...
					사이드바 -
					<select class="form-select" name="mobile_sidebar_attendance" id="mobile_sidebar_attendance">
						<option value="">기본설정따름</option>
