<div class="box">
	<div class="box-header">
		<ul class="nav nav-tabs mb-3">
			<li class="nav-item"><a class="nav-link" href="<?php echo admin_url($this->pagedir); ?>" onclick="return check_form_changed();">일반기능</a></li>
			<li class="nav-item"><a class="nav-link active" href="<?php echo admin_url($this->pagedir . '/points'); ?>" onclick="return check_form_changed();">시간/포인트설정</a></li>
