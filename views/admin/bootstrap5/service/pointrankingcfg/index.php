			...
			<div class="input-group">
				<label class="col-sm-2 control-label">포인트랭킹 기능 사용</label>
					<div class="col-sm-10">
						...
						<div style="padding-top:7px;"><span class="bi bi-trophy"></span>
				...
				<div class="input-group">
					...
					<div class="col-sm-10 form-inline">
						...
						사이드바 -
						<select class="form-select" name="sidebar_pointranking" id="sidebar_pointranking">
				...
				<div class="input-group">
					...
					<div class="col-sm-10 form-inline">
						...
						사이드바 -
						<select class="form-select" name="mobile_sidebar_pointranking" id="mobile_sidebar_pointranking">
							<option value="">기본설정따름</option>
