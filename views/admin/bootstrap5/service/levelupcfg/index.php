		...
		?>
			...
			<div class="input-group">
				...
				<div class="col-sm-10">
					...
					<label class=" form-inline" style="padding-top:7px;padding-left:10px;"><span class="bi bi-level-up"></span>
			...
			<div class="input-group">
				...
				<div class="col-sm-10 form-inline">
					...
					사이드바 -
					<select class="form-select" name="sidebar_levelup" id="sidebar_levelup">
			...
			<div class="input-group">
				...
				<div class="col-sm-10 form-inline">
					...
					사이드바 -
					<select class="form-select" name="mobile_sidebar_levelup" id="mobile_sidebar_levelup">
						<option value="">기본설정따름</option>
