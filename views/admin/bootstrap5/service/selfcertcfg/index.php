<div class="box">
	<div class="box-header">
		<ul class="nav nav-tabs mb-3">
			<li class="nav-item"><a class="nav-link active" href="<?php echo admin_url($this->pagedir); ?>" onclick="return check_form_changed();">본인인증설정</a></li>
		...
		?>
			...
			<div class="input-group">
				...
				<div class="col-sm-10 form-inline">
					...
					사이드바 -
					<select class="form-select" name="sidebar_selfcert" id="sidebar_selfcert">
			...
			<div class="input-group">
				...
				<div class="col-sm-10 form-inline">
					...
					사이드바 -
					<select class="form-select" name="mobile_sidebar_selfcert" id="mobile_sidebar_selfcert">
						<option value="">기본설정따름</option>
