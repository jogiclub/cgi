<div class="box">
	<div class="box-header">
		<ul class="nav nav-tabs mb-3">
			<li class="nav-item"><a class="nav-link" href="<?php echo admin_url($this->pagedir); ?>" onclick="return check_form_changed();">본인인증설정</a></li>
			<li class="nav-item"><a class="nav-link active" href="<?php echo admin_url($this->pagedir . '/boards'); ?>" onclick="return check_form_changed();">게시판별사용여부</a></li>
		</ul>
	</div>
	<div class="box-table">
		<?php
