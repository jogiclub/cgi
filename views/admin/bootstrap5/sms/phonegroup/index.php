		...
		?>
			...
			<div class="list-group">
				...
				<div id="sortable">
					...
					?>
						<div class="input-group list-group-item">
							<div class="col-sm-2"><div class="bi bi-arrows" style="cursor:pointer;"></div><input type="hidden" name="smg_id[<?php echo element('smg_id', $result); ?>]" value="<?php echo element('smg_id', $result); ?>" /></div>
