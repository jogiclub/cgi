			...
			?>
				<tr>
					...
					<td class="td_mngsmall">
						<button type="button" class="btn btn-secondary btn-xs" onclick="sms_obj.group_add(<?php echo element('smg_id', $result); ?>, '<?php echo html_escape(element('smg_name', $result)); ?>', '<?php echo number_format(element('receive_num', $result)); ?>')">추가</button>
					</td>
				</tr>
			<?php
				}
