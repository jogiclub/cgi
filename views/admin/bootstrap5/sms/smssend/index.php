					...
					<tr>
						<td class="favorite_area" style="vertical-align:top;">
							...
							<form name="emo_sch" id="emo_sch" class="form-inline" method="get" action="<?php echo current_url(); ?>">
								...
								<button type="submit" class="btn btn-xs btn-secondary">검색</button>
							</form>
							...
							<div>
								...
								?>
									...
									<div style="width:190px;">
										...
										<div class="form-inline">
											...
											<div class="pull-right" style="position:relative;">
												<button type="button" id="write_sc_btn" class="btn btn-secondary btn-xs write_scemo_btn">특수기호</button>
												...
												<button type="button" id="write_emo_btn" class="btn btn-secondary btn-xs write_scemo_btn">이모티콘</button>
									...
									<div class="input-group">
										받는사람
										<button type="button" class="btn btn-secondary btn-xs" onclick="phone_list_del()">선택삭제</button>
										...
										<button type="button" class="btn btn-secondary btn-xs" onclick="phone_add()">추가</button><br />
									</div>
						...
						<td class="phone_list_area" style="vertical-align:top;">
							<div id="send_book">
								...
								<div class="input-group pull-right">
									<a href="#book_group" id="book_group" class="btn btn-secondary btn-xs">그룹</a>
									<a href="#book_person" id="book_person" class="btn btn-secondary btn-xs">개인</a>
								</div>
								<div id="num_book"></div>
