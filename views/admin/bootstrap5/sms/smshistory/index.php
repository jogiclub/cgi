				...
				<table class="table table-hover table-striped table-bordered">
					...
					?>
						<tr>
							...
							<td><a href="<?php echo admin_url('sms/smshistorynum'); ?>/?ssc_id=<?php echo element(element('primary_key', $view), $result); ?>" class="btn btn-outline btn-secondary btn-xs">세부보기</a></td>
						</tr>
					<?php
						}
					}
