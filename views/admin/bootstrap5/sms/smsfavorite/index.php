			...
			<div class="box-table-header">
				...
				?>
					<div class="col-md-6"><div class="btn-group pull-right" role="group" aria-label="...">
						...
						<a href="<?php echo element('write_url', $view); ?>" class="btn btn-outline btn-danger ">문자추가</a>
					</div>
				<?php
			...
			<div>
				...
				?>
					<div class="px200 pr20 pull-left">
						...
						<p><a href="<?php echo admin_url($this->pagedir); ?>/write/<?php echo element(element('primary_key', $view), $result); ?>?<?php echo $this->input->server('QUERY_STRING', null, ''); ?>" class="btn btn-outline btn-secondary btn-xs">수정</a></p>
					</div>
				<?php
						$i++;
						if ($i % 4 === 0 && $open) {
