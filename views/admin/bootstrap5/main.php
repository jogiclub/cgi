<div class="col-sm-6">
	<div class="panel panel-default">
		...
		<div class="panel-heading">최근등록회원
			<div class="view-all">
				<a href="<?php echo admin_url('member/members'); ?>">More <i class="bi bi-angle-right"></i></a>
			</div>
		</div>
		<!-- Table -->
...
<div class="col-sm-6">
	<div class="panel panel-default">
		...
		<div class="panel-heading">최근포인트
			<div class="view-all">
				<a href="<?php echo admin_url('member/points'); ?>">More <i class="bi bi-angle-right"></i></a>
			</div>
		</div>
		<!-- Table -->
		<table class="table table-hover table-striped">
...
<div class="col-sm-6">
	<div class="panel panel-default">
		...
		<div class="panel-heading">최근게시물
			<div class="view-all">
				<a href="<?php echo admin_url('board/post'); ?>">More <i class="bi bi-angle-right"></i></a>
			</div>
		</div>
		<!-- Table -->
		<table class="table table-hover table-striped">
...
<div class="col-sm-6">
	<div class="panel panel-default">
		...
		<div class="panel-heading">최근댓글
			<div class="view-all">
				<a href="<?php echo admin_url('board/comment'); ?>">More <i class="bi bi-angle-right"></i></a>
			</div>
		</div>
		<!-- Table -->
		<table class="table table-hover table-striped">
