<div class="box">
	<div class="box-header">
		<ul class="nav nav-tabs mb-3">
			...
			<li class="nav-item"><a class="nav-link" href="<?php echo admin_url($this->pagedir . '/registerform'); ?>" onclick="return check_form_changed();">가입폼관리</a></li>
			<li class="nav-item"><a class="nav-link active" href="<?php echo admin_url($this->pagedir . '/membermodify'); ?>" onclick="return check_form_changed();">정보수정시</a></li>
