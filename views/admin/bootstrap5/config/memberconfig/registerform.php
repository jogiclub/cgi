<div class="box">
	<div class="box-header">
		<ul class="nav nav-tabs mb-3">
			...
			<li class="nav-item"><a class="nav-link active" href="<?php echo admin_url($this->pagedir . '/registerform'); ?>" onclick="return check_form_changed();">가입폼관리</a></li>
			<li class="nav-item"><a class="nav-link" href="<?php echo admin_url($this->pagedir . '/membermodify'); ?>" onclick="return check_form_changed();">정보수정시</a></li>
			<li class="nav-item"><a class="nav-link" href="<?php echo admin_url($this->pagedir . '/login'); ?>" onclick="return check_form_changed();">로그인</a></li>
			<li class="nav-item"><a class="nav-link" href="<?php echo admin_url($this->pagedir . '/alarm'); ?>" onclick="return check_form_changed();">알림 설정</a></li>
			<li class="nav-item"><a class="nav-link" href="<?php echo admin_url($this->pagedir . '/sociallogin'); ?>" onclick="return check_form_changed();">소셜로그인</a></li>
		</ul>
	</div>
	<div class="box-table">
		...
		?>
			...
			<div class="list-group">
				...
				?>
					<div class="input-group list-group-item">
						<div class="col-sm-1"><div class="bi bi-arrows" style="cursor:pointer;"></div><input type="hidden" name="key[<?php echo $key; ?>]" value="<?php echo $key; ?>" /><input type="hidden" name="basic[<?php echo $key; ?>]" value="<?php echo $key; ?>" /></div>
				...
				?>
					<div class="input-group list-group-item">
						<div class="col-sm-1"><div class="bi bi-arrows" style="cursor:pointer;"></div><input type="hidden" name="key[<?php echo $key; ?>]" value="<?php echo $key; ?>" /></div>
						<div class="col-sm-2"><?php echo $key; ?>
						...
						<div class="col-sm-1"><button type="button" class="btn btn-outline btn-secondary btn-xs btn-delete-row" >삭제</button></div>
					</div>
				<?php
						}
					}
