...
<div class="headerbar">
	<div class="topbar">
		...
		<div class="options input-group form-inline">
		...
		<?php if (element('use_sidebar_option', $view)) { ?>
			<div class="options input-group form-inline">
				...
				<select class="form-select" name="sidebar" id="sidebar">
		...
		<div class="options input-group form-inline">
			...
			<select class="form-select" name="skin" id="skin">
				<?php echo element('skin_option', $view); ?>
			</select>
		</div>
		<div class="options input-group form-inline">
			<div class="option_title">PC/모바일 -</div>
			<select class="form-select" name="is_mobile" id="is_mobile">
