<div class="box">
	<div class="box-header">
		<ul class="nav nav-tabs mb-3">
			<li class="nav-item"><a class="nav-link active" href="<?php echo admin_url($this->pagedir); ?>" onclick="return check_form_changed();">레이아웃/스킨설정</a></li>
			<li class="nav-item"><a class="nav-link" href="<?php echo admin_url($this->pagedir . '/metatag'); ?>" onclick="return check_form_changed();">메타태그</a></li>
			<li class="nav-item"><a class="nav-link" href="<?php echo admin_url($this->pagedir . '/favicon'); ?>" onclick="return check_form_changed();">파비콘 등록</a></li>
		</ul>
	</div>
	<div class="box-table">
		...
		?>
			...
			<div class="table-responsive input-group input-group-sm">
				<table class="table table-bordered table-hover table-striped">
					<tbody>
						...
						<tr class="bg bg-warning">
							...
							<td>
								<div class="form-inline">_layout/
									<select class="form-select" name="layout_default" id="layout_default">
							...
							<td>
								<div class="form-inline">
									<select class="form-select" name="skin_default" id="skin_default">
							...
							<td>
								<div class="form-inline">_layout/
									<select class="form-select" name="mobile_layout_default" id="mobile_layout_default">
							...
							<td>
								<div class="form-inline">
									<select class="form-select" name="mobile_skin_default" id="mobile_skin_default">
						...
						<tr>
							...
							<td>
								<div class="form-inline">
									<select class="form-select" name="layout_main" id="layout_main">
							...
							<td>
								<div class="form-inline">
									<select class="form-select" name="sidebar_main" id="sidebar_main">
							...
							<td>
								<div class="form-inline">main/
									<select class="form-select" name="skin_main" id="skin_main">
							...
							<td>
								<div class="form-inline">
									<select class="form-select" name="mobile_layout_main" id="mobile_layout_main">
							...
							<td>
								<div class="form-inline">
									<select class="form-select" name="mobile_sidebar_main" id="mobile_sidebar_main">
										<option value="">기본설정따름</option>
							...
							<td>
								<div class="form-inline">main/
									<select class="form-select" name="mobile_skin_main" id="mobile_skin_main">
						...
						<tr>
							...
							<td>
								<div class="form-inline">
									<select class="form-select" name="layout_board" id="layout_board">
							...
							<td>
								<div class="form-inline">
									<select class="form-select" name="sidebar_board" id="sidebar_board">
										<option value="">기본설정따름</option>
							...
							<td>
								<div class="form-inline">board/
									<select class="form-select" name="skin_board" id="skin_board">
							...
							<td>
								<div class="form-inline">
									<select class="form-select" name="mobile_layout_board" id="mobile_layout_board">
							...
							<td>
								<div class="form-inline">
									<select class="form-select" name="mobile_sidebar_board" id="mobile_sidebar_board">
										<option value="">기본설정따름</option>
							...
							<td>
								<div class="form-inline">board/
									<select class="form-select" name="mobile_skin_board" id="mobile_skin_board">
						...
						<tr>
							...
							<td>
								<div class="form-inline">
									<select class="form-select" name="layout_group" id="layout_group">
							...
							<td>
								<div class="form-inline">
									<select class="form-select" name="sidebar_group" id="sidebar_group">
										<option value="">기본설정따름</option>
							...
							<td>
								<div class="form-inline">group/
									<select class="form-select" name="skin_group" id="skin_group">
							...
							<td>
								<div class="form-inline">
									<select class="form-select" name="mobile_layout_group" id="mobile_layout_group">
							...
							<td>
								<div class="form-inline">
									<select class="form-select" name="mobile_sidebar_group" id="mobile_sidebar_group">
										<option value="">기본설정따름</option>
							...
							<td>
								<div class="form-inline">group/
									<select class="form-select" name="mobile_skin_group" id="mobile_skin_group">
						...
						<tr>
							...
							<td>
								<div class="form-inline">
									<select class="form-select" name="layout_document" id="layout_document">
							...
							<td>
								<div class="form-inline">
									<select class="form-select" name="sidebar_document" id="sidebar_document">
										<option value="">기본설정따름</option>
							...
							<td>
								<div class="form-inline">document/
									<select class="form-select" name="skin_document" id="skin_document">
							...
							<td>
								<div class="form-inline">
									<select class="form-select" name="mobile_layout_document" id="mobile_layout_document">
							...
							<td>
								<div class="form-inline">
									<select class="form-select" name="mobile_sidebar_document" id="mobile_sidebar_document">
										<option value="">기본설정따름</option>
							...
							<td>
								<div class="form-inline">document/
									<select class="form-select" name="mobile_skin_document" id="mobile_skin_document">
						...
						<tr>
							...
							<td>
								<div class="form-inline">
									<select class="form-select" name="layout_faq" id="layout_faq">
							...
							<td>
								<div class="form-inline">
									<select class="form-select" name="sidebar_faq" id="sidebar_faq">
										<option value="">기본설정따름</option>
							...
							<td>
								<div class="form-inline">faq/
									<select class="form-select" name="skin_faq" id="skin_faq">
							...
							<td>
								<div class="form-inline">
									<select class="form-select" name="mobile_layout_faq" id="mobile_layout_faq">
							...
							<td>
								<div class="form-inline">
									<select class="form-select" name="mobile_sidebar_faq" id="mobile_sidebar_faq">
										<option value="">기본설정따름</option>
							...
							<td>
								<div class="form-inline">faq/
									<select class="form-select" name="mobile_skin_faq" id="mobile_skin_faq">
						...
						<tr>
							...
							<td>
								<div class="form-inline">
									<select class="form-select" name="layout_register" id="layout_register">
							...
							<td>
								<div class="form-inline">
									<select class="form-select" name="sidebar_register" id="sidebar_register">
										<option value="">기본설정따름</option>
							...
							<td>
								<div class="form-inline">register/
									<select class="form-select" name="skin_register" id="skin_register">
							...
							<td>
								<div class="form-inline">
									<select class="form-select" name="mobile_layout_register" id="mobile_layout_register">
							...
							<td>
								<div class="form-inline">
									<select class="form-select" name="mobile_sidebar_register" id="mobile_sidebar_register">
										<option value="">기본설정따름</option>
							...
							<td>
								<div class="form-inline">register/
									<select class="form-select" name="mobile_skin_register" id="mobile_skin_register">
						...
						<tr>
							...
							<td>
								<div class="form-inline">
									<select class="form-select" name="layout_findaccount" id="layout_findaccount">
							...
							<td>
								<div class="form-inline">
									<select class="form-select" name="sidebar_findaccount" id="sidebar_findaccount">
										<option value="">기본설정따름</option>
							...
							<td>
								<div class="form-inline">findaccount/
									<select class="form-select" name="skin_findaccount" id="skin_findaccount">
							...
							<td>
								<div class="form-inline">
									<select class="form-select" name="mobile_layout_findaccount" id="mobile_layout_findaccount">
							...
							<td>
								<div class="form-inline">
									<select class="form-select" name="mobile_sidebar_findaccount" id="mobile_sidebar_findaccount">
										<option value="">기본설정따름</option>
							...
							<td>
								<div class="form-inline">findaccount/
									<select class="form-select" name="mobile_skin_findaccount" id="mobile_skin_findaccount">
						...
						<tr>
							...
							<td>
								<div class="form-inline">
									<select class="form-select" name="layout_login" id="layout_login">
							...
							<td>
								<div class="form-inline">
									<select class="form-select" name="sidebar_login" id="sidebar_login">
										<option value="">기본설정따름</option>
							...
							<td>
								<div class="form-inline">login/
									<select class="form-select" name="skin_login" id="skin_login">
							...
							<td>
								<div class="form-inline">
									<select class="form-select" name="mobile_layout_login" id="mobile_layout_login">
							...
							<td>
								<div class="form-inline">
									<select class="form-select" name="mobile_sidebar_login" id="mobile_sidebar_login">
										<option value="">기본설정따름</option>
							...
							<td>
								<div class="form-inline">login/
									<select class="form-select" name="mobile_skin_login" id="mobile_skin_login">
						...
						<tr>
							...
							<td>
								<div class="form-inline">
									<select class="form-select" name="layout_mypage" id="layout_mypage">
							...
							<td>
								<div class="form-inline">
									<select class="form-select" name="sidebar_mypage" id="sidebar_mypage">
										<option value="">기본설정따름</option>
							...
							<td>
								<div class="form-inline">mypage/
									<select class="form-select" name="skin_mypage" id="skin_mypage">
							...
							<td>
								<div class="form-inline">
									<select class="form-select" name="mobile_layout_mypage" id="mobile_layout_mypage">
							...
							<td>
								<div class="form-inline">
									<select class="form-select" name="mobile_sidebar_mypage" id="mobile_sidebar_mypage">
										<option value="">기본설정따름</option>
							...
							<td>
								<div class="form-inline">mypage/
									<select class="form-select" name="mobile_skin_mypage" id="mobile_skin_mypage">
						...
						<tr>
							...
							<td>
								<div class="form-inline">
									<select class="form-select" name="layout_currentvisitor" id="layout_currentvisitor">
							...
							<td>
								<div class="form-inline">
									<select class="form-select" name="sidebar_currentvisitor" id="sidebar_currentvisitor">
										<option value="">기본설정따름</option>
							...
							<td>
								<div class="form-inline">currentvisitor/
									<select class="form-select" name="skin_currentvisitor" id="skin_currentvisitor">
							...
							<td>
								<div class="form-inline">
									<select class="form-select" name="mobile_layout_currentvisitor" id="mobile_layout_currentvisitor">
							...
							<td>
								<div class="form-inline">
									<select class="form-select" name="mobile_sidebar_currentvisitor" id="mobile_sidebar_currentvisitor">
										<option value="">기본설정따름</option>
							...
							<td>
								<div class="form-inline">currentvisitor/
									<select class="form-select" name="mobile_skin_currentvisitor" id="mobile_skin_currentvisitor">
						...
						<tr>
							...
							<td>
								<div class="form-inline">
									<select class="form-select" name="layout_search" id="layout_search">
							...
							<td>
								<div class="form-inline">
									<select class="form-select" name="sidebar_search" id="sidebar_search">
										<option value="">기본설정따름</option>
							...
							<td>
								<div class="form-inline">search/
									<select class="form-select" name="skin_search" id="skin_search">
							...
							<td>
								<div class="form-inline">
									<select class="form-select" name="mobile_layout_search" id="mobile_layout_search">
							...
							<td>
								<div class="form-inline">
									<select class="form-select" name="mobile_sidebar_search" id="mobile_sidebar_search">
										<option value="">기본설정따름</option>
							...
							<td>
								<div class="form-inline">search/
									<select class="form-select" name="mobile_skin_search" id="mobile_skin_search">
						...
						<tr>
							...
							<td>
								<div class="form-inline">
									<select class="form-select" name="layout_tag" id="layout_tag">
							...
							<td>
								<div class="form-inline">
									<select class="form-select" name="sidebar_tag" id="sidebar_tag">
										<option value="">기본설정따름</option>
							...
							<td>
								<div class="form-inline">tag/
									<select class="form-select" name="skin_tag" id="skin_tag">
							...
							<td>
								<div class="form-inline">
									<select class="form-select" name="mobile_layout_tag" id="mobile_layout_tag">
							...
							<td>
								<div class="form-inline">
									<select class="form-select" name="mobile_sidebar_tag" id="mobile_sidebar_tag">
										<option value="">기본설정따름</option>
							...
							<td>
								<div class="form-inline">tag/
									<select class="form-select" name="mobile_skin_tag" id="mobile_skin_tag">
						...
						<tr>
							...
							<td>
								<div class="form-inline">
									<select class="form-select" name="layout_note" id="layout_note">
							...
							<td>
								<div class="form-inline">note/
									<select class="form-select" name="skin_note" id="skin_note">
							...
							<td>
								<div class="form-inline">
									<select class="form-select" name="mobile_layout_note" id="mobile_layout_note">
							...
							<td>
								<div class="form-inline">note/
									<select class="form-select" name="mobile_skin_note" id="mobile_skin_note">
						...
						<tr>
							...
							<td>
								<div class="form-inline">
									<select class="form-select" name="layout_profile" id="layout_profile">
							...
							<td>
								<div class="form-inline">profile/
									<select class="form-select" name="skin_profile" id="skin_profile">
							...
							<td>
								<div class="form-inline">
									<select class="form-select" name="mobile_layout_profile" id="mobile_layout_profile">
							...
							<td>
								<div class="form-inline">profile/
									<select class="form-select" name="mobile_skin_profile" id="mobile_skin_profile">
						...
						<tr>
							...
							<td>
								<div class="form-inline">
									<select class="form-select" name="layout_formmail" id="layout_formmail">
							...
							<td>
								<div class="form-inline">formmail/
									<select class="form-select" name="skin_formmail" id="skin_formmail">
							...
							<td>
								<div class="form-inline">
									<select class="form-select" name="mobile_layout_formmail" id="mobile_layout_formmail">
							...
							<td>
								<div class="form-inline">formmail/
									<select class="form-select" name="mobile_skin_formmail" id="mobile_skin_formmail">
						...
						<tr>
							...
							<td>
								<div class="form-inline">
									<select class="form-select" name="layout_notification" id="layout_notification">
							...
							<td>
								<div class="form-inline">
									<select class="form-select" name="sidebar_notification" id="sidebar_notification">
										<option value="">기본설정따름</option>
							...
							<td>
								<div class="form-inline">notification/
									<select class="form-select" name="skin_notification" id="skin_notification">
							...
							<td>
								<div class="form-inline">
									<select class="form-select" name="mobile_layout_notification" id="mobile_layout_notification">
							...
							<td>
								<div class="form-inline">
									<select class="form-select" name="mobile_sidebar_notification" id="mobile_sidebar_notification">
										<option value="">기본설정따름</option>
							...
							<td>
								<div class="form-inline">notification/
									<select class="form-select" name="mobile_skin_notification" id="mobile_skin_notification">
						...
						<tr>
							...
							<td>
								<div class="form-inline">
									<select class="form-select" name="layout_helptool" id="layout_helptool">
							...
							<td>
								<div class="form-inline">helptool/
									<select class="form-select" name="skin_helptool" id="skin_helptool">
							...
							<td>
								<div class="form-inline">
									<select class="form-select" name="mobile_layout_helptool" id="mobile_layout_helptool">
							...
							<td>
								<div class="form-inline">helptool/
									<select class="form-select" name="mobile_skin_helptool" id="mobile_skin_helptool">
						...
						<tr>
							...
							<td>
								<div class="form-inline">popup/
									<select class="form-select" name="skin_popup" id="skin_popup">
							...
							<td>
								<div class="form-inline">popup/
									<select class="form-select" name="mobile_skin_popup" id="mobile_skin_popup">
