<div class="box">
	<div class="box-header">
		<ul class="nav nav-tabs mb-3">
			<li class="nav-item"><a class="nav-link active" href="<?php echo admin_url($this->pagedir); ?>" onclick="return check_form_changed();">RSS 피드</a></li>
			<li class="nav-item"><a class="nav-link" href="<?php echo admin_url($this->pagedir . '/sitemap'); ?>" onclick="return check_form_changed();">사이트맵</a></li>
			<li class="nav-item"><a class="nav-link" href="<?php echo admin_url($this->pagedir . '/naverblog'); ?>" onclick="return check_form_changed();">네이버블로그자동등록</a></li>
		</ul>
	</div>
	<div class="box-table">
		<?php
