<div class="box">
	<div class="box-header">
		<ul class="nav nav-tabs mb-3">
			<li class="nav-item"><a class="nav-link active" href="<?php echo admin_url($this->pagedir . '/register'); ?>" onclick="return check_form_changed();">회원가입</a></li>
		...
		?>
			...
			<div class="input-group">
				<label class="col-sm-2 control-label">
					...
					<button type="button" class="btn btn-xs btn-secondary reset_email_to_user">내용초기화하기</button>
				</label>
				<div class="col-sm-10">
					<div class="input-group col-sm-12">
			...
			<div class="input-group">
				<label class="col-sm-2 control-label">
					...
					<button type="button" class="btn btn-xs btn-secondary reset_email_to_user_verify">내용초기화하기</button>
				</label>
				<div class="col-sm-10">
					<div class="input-group col-sm-12">
			...
			<div class="input-group">
				<label class="col-sm-2 control-label">
					회원에게 보낼 쪽지<br />
					<button type="button" class="btn btn-xs btn-secondary reset_note_to_user">내용초기화하기</button>
				</label>
				<div class="col-sm-10">
					<div class="input-group col-sm-12">
			...
			<div class="input-group">
				<label class="col-sm-2 control-label">
					회원에게 보낼 문자<br />
					<button type="button" class="btn btn-xs btn-secondary reset_sms_to_user">내용초기화하기</button>
				</label>
				<div class="col-sm-10 form-inline has-success ">
