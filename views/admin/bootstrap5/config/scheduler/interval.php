<div class="box">
	<div class="box-header">
		<ul class="nav nav-tabs mb-3">
			<li class="nav-item"><a class="nav-link" href="<?php echo admin_url($this->pagedir); ?>" onclick="return check_form_changed();">스케쥴러 등록</a></li>
			<li class="nav-item"><a class="nav-link active" href="<?php echo admin_url($this->pagedir . '/interval'); ?>" onclick="return check_form_changed();">스케쥴 주기명</a></li>
		</ul>
	</div>
	<div class="box-table">
			...
			<div class="list-group">
				...
				?>
					<div class="input-group list-group-item">
						...
						<div class="col-sm-1"><button type="button" class="btn btn-outline btn-secondary btn-xs <?php echo element('registered_scheduler', $result) ? 'btn-alert-delete' : 'btn-delete-row'; ?>" >삭제</button></div>
					</div>
				<?php
					}
				}
