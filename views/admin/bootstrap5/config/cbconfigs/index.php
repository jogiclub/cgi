<div class="box">
	<div class="box-header">
		<ul class="nav nav-tabs mb-3">
			<li class="nav-item"><a class="nav-link active" href="<?php echo admin_url($this->pagedir); ?>" onclick="return check_form_changed();">기본정보</a></li>
	...
	<div class="box-table">
		...
		?>
			...
			<div class="input-group mb-3">
				...
				<div class="col-sm-10">
					<label for="use_naver_syndi_log" class="form-check-label">
						<input class="form-check-input" type="checkbox" name="use_naver_syndi_log" id="use_naver_syndi_log" value="1" <?php echo set_checkbox('use_naver_syndi_log', '1', (element('use_naver_syndi_log', element('data', $view)) ? true : false)); ?> /> 핑 전송 로그를 남깁니다
					</label>
				</div>
			</div>
			<div class="input-group mb-3">
			...
			<div class="input-group mb-3">
				...
				<div class="col-sm-10">
					<label for="open_currentvisitor" class="form-check-label">
						<input class="form-check-input" type="checkbox" name="open_currentvisitor" id="open_currentvisitor" value="1" <?php echo set_checkbox('open_currentvisitor', '1', (element('open_currentvisitor', element('data', $view)) ? true : false)); ?> /> 현재접속자를 공개합니다
			...
			<div class="input-group mb-3">
				...
				<div class="col-sm-10">
					<label for="use_copy_log" class="form-check-label">
						<input class="form-check-input" type="checkbox" name="use_copy_log" id="use_copy_log" value="1" <?php echo set_checkbox('use_copy_log', '1', (element('use_copy_log', element('data', $view)) ? true : false)); ?> /> 로그를 남깁니다
					</label>
				</div>
			</div>
			<div class="input-group mb-3">
			...
			<div class="input-group mb-3">
				...
				<div class="col-sm-10">
					<label for="use_recaptcha_0" class="form-check-label">
					...
					<br />
					<label for="use_recaptcha_1" class="form-check-label">
					...
					<br />
					<label for="use_recaptcha_2" class="form-check-label">
