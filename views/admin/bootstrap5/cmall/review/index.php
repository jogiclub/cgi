		...
		?>
			...
			?>
				<div class="col-md-6"><div class="btn-group pull-right" role="group" aria-label="...">
					...
					<button type="button" class="btn btn-outline btn-secondary  btn-list-update btn-list-selected disabled" data-list-update-url = "<?php echo element('list_update_url', $view); ?>" >선택승인</button>
				...
				<table class="table table-hover table-striped table-bordered">
					...
					?>
						<tr>
							...
							<td><?php echo (element('cre_status', $result)) ? '<button class="btn btn-xs btn-secondary">승인</button>' : '<button class="btn btn-xs btn-danger">미승인</button>'; ?></td>
