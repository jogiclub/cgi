<div class="box">
	<div class="box-header">
		<ul class="nav nav-tabs mb-3">
			<li class="nav-item"><a class="nav-link active" href="<?php echo admin_url($this->pagedir . '/cash_to_contents'); ?>" onclick="return check_form_changed();">카드/이체 등으로 컨텐츠 구매시</a></li>
