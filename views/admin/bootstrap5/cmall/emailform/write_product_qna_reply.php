<div class="box">
	<div class="box-header">
		<ul class="nav nav-tabs mb-3">
			...
			<li class="nav-item"><a class="nav-link" href="<?php echo admin_url($this->pagedir . '/write_product_review'); ?>" onclick="return check_form_changed();">상품후기 작성시</a></li>
			...
			<li class="nav-item"><a class="nav-link active" href="<?php echo admin_url($this->pagedir . '/write_product_qna_reply'); ?>" onclick="return check_form_changed();">상품문의 답변시</a></li>
		</ul>
	</div>
	<div class="box-table">
		<?php
