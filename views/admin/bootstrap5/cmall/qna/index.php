					...
					<table class="table table-hover table-striped table-bordered">
						...
						?>
							<tr>
								...
								<td>
									<?php echo element('cqa_receive_email', $result) ? '<i class="bi bi-check-square-o"></i>' : '<i class="bi bi-square-o"></i>';; ?>
									<?php echo element('cqa_receive_sms', $result) ? '<i class="bi bi-check-square-o"></i>' : '<i class="bi bi-square-o"></i>';; ?>
								</td>
