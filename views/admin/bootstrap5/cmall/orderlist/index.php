	...
	?>
		<div class="box-table-header">
			<div class="btn-group btn-group-sm" role="group">
				<a href="<?php echo admin_url('cmall/orderlist'); ?>" class="btn  <?php echo ( ! $this->input->get('cor_pay_type')) ? 'btn-success' : 'btn-secondary';?>">전체내역</a>
				<a href="<?php echo admin_url('cmall/orderlist'); ?>?cor_pay_type=bank" class="btn  <?php echo ($this->input->get('cor_pay_type') === 'bank') ? 'btn-info' : 'btn-secondary';?>">무통장</a>
				<a href="<?php echo admin_url('cmall/orderlist'); ?>?cor_pay_type=card" class="btn  <?php echo ($this->input->get('cor_pay_type') === 'card') ? 'btn-info' : 'btn-secondary';?>">카드</a>
				<a href="<?php echo admin_url('cmall/orderlist'); ?>?cor_pay_type=realtime" class="btn  <?php echo ($this->input->get('cor_pay_type') === 'realtime') ? 'btn-info' : 'btn-secondary';?>">실시간</a>
				<a href="<?php echo admin_url('cmall/orderlist'); ?>?cor_pay_type=vbank" class="btn  <?php echo ($this->input->get('cor_pay_type') === 'vbank') ? 'btn-info' : 'btn-secondary';?>">가상계좌</a>
				<a href="<?php echo admin_url('cmall/orderlist'); ?>?cor_pay_type=phone" class="btn  <?php echo ($this->input->get('cor_pay_type') === 'phone') ? 'btn-info' : 'btn-secondary';?>">핸드폰</a>
			</div>
			<?php
			ob_start();
			?>
