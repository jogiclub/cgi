...
.input-group .pg_info .form-inline{background-color:#FFF;padding-bottom:10px}
...
<div class="box pg_setting">
	<div class="box-header">
		<ul class="nav nav-tabs mb-3">
			...
			<li class="nav-item"><a class="nav-link" href="<?php echo admin_url($this->pagedir . '/editor'); ?>" onclick="return check_form_changed();">에디터기능</a></li>
			...
			<li class="nav-item"><a class="nav-link active" href="<?php echo admin_url($this->pagedir . '/paymentconfig'); ?>" onclick="return check_form_changed();">결제기능</a></li>
	...
	<div class="box-table">
		...
		?>
			...
			<div class="input-group" id="kcp_info_anchor">
			...
			<div class="input-group" id="lg_info_anchor">
			...
			<div class="input-group" id="inicis_info_anchor">
