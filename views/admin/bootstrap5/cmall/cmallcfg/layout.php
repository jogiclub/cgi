<div class="box">
	<div class="box-header">
		<ul class="nav nav-tabs mb-3">
			...
			<li class="nav-item"><a class="nav-link active" href="<?php echo admin_url($this->pagedir . '/layout'); ?>" onclick="return check_form_changed();">레이아웃/메타태그</a></li>
	...
	<div class="box-table">
		...
		?>
			...
			<div class="input-group">
				...
				사이드바 -
					<select class="form-select" name="sidebar_cmall" id="sidebar_cmall">
			...
			<div class="input-group">
				...
				사이드바 -
					<select class="form-select" name="mobile_sidebar_cmall" id="mobile_sidebar_cmall">
						<option value="">기본설정따름</option>
