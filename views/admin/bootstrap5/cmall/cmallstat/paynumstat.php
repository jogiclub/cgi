<div class="box">
	<div class="box-header">
		<ul class="nav nav-tabs mb-3">
			...
			<li class="nav-item"><a class="nav-link active" href="<?php echo admin_url($this->pagedir . '/paynumstat'); ?>">결제회수별 회원수</a></li>
		</ul>
	</div>
	<div class="box-table">
		<div class="box-table-header">
			<form class="form-inline" name="flist" action="<?php echo current_url(); ?>" method="get" >
				<div class="row">
					...
					<div class="col-sm-6">
                        <div class="input-group justify-content-end"><button type="submit" class="btn btn-secondary ">확인</button></div>
				</div>
			</form>
		</div>
