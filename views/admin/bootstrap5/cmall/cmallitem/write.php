	...
	<div class="box-table">
		...
		?>
			...
			<div class="box-table-header">
				...
				<a data-toggle="collapse" href="#cmalltab1" aria-expanded="true" aria-controls="cmalltab1"><i class="bi bi-chevron-up pull-right"></i></a>
			</div>
				...
				<div class="input-group">
					...
					<div class="col-sm-10">
						...
						function get_subcat($category, $item_category, $key, $display)
						{
							...
							$html = '';
							if ($subcat) {
								$html .= '<div class="input-group" id="catwrap_' . $key . '" style="vertical-align:margin-left:10px;top;display:' . $display . ';" >';
			...
			<div class="box-table-header">
				...
				<a data-toggle="collapse" href="#cmalltab2" aria-expanded="true" aria-controls="cmalltab2"><i class="bi bi-chevron-up pull-right"></i></a>
			</div>
			<div class="collapse in" id="cmalltab2">
				...
				<div class="input-group">
					...
					<div class="col-sm-10 form-inline">
						...
						사이드바 -
						<select class="form-select" name="item_sidebar" id="item_sidebar">
				...
				<div class="input-group">
					...
					<div class="col-sm-10 form-inline">
						...
						사이드바 -
						<select class="form-select" name="item_mobile_sidebar" id="item_mobile_sidebar">
							<option value="">기본설정따름</option>
			...
			<div class="box-table-header">
				...
				<a data-toggle="collapse" href="#cmalltab3" aria-expanded="true" aria-controls="cmalltab3"><i class="bi bi-chevron-up pull-right"></i></a>
			</div>
			...
			<div class="box-table-header">
				...
				<a data-toggle="collapse" href="#cmalltab4" aria-expanded="true" aria-controls="cmalltab4"><i class="bi bi-chevron-up pull-right"></i></a>
			</div>
			...
			<div class="box-table-header">
				...
				<a data-toggle="collapse" href="#cmalltab5" aria-expanded="true" aria-controls="cmalltab5"><i class="bi bi-chevron-up pull-right"></i></a>
			</div>
			...
			<div class="box-table-header">
				...
				<a data-toggle="collapse" href="#cmalltab6" aria-expanded="true" aria-controls="cmalltab6"><i class="bi bi-chevron-up pull-right"></i></a>
			</div>
			...
			<div class="col-md-6"><div class="btn-group pull-right" role="group" aria-label="...">
				<button type="button" class="btn btn-secondary  btn-history-back" >목록으로</button>
