			...
			<form class="form-inline" name="flist" method="get" >
				<div class="row">
					...
					<div class="col-sm-6">
						...
						<button data-page-url="<?php echo admin_url($this->pagedir . '/visit'); ?>" class="btn btn-secondary  statsubmit">방문자</button>
						<button data-page-url="<?php echo admin_url($this->pagedir . '/domain'); ?>" class="btn btn-secondary  statsubmit">도메인</button>
						<button data-page-url="<?php echo admin_url($this->pagedir . '/browser'); ?>" class="btn btn-warning  statsubmit">브라우저</button>
