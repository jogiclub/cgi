			...
			<div class="box-table-header">
				...
				?>
					<div class="col-md-6"><div class="btn-group pull-right" role="group" aria-label="...">
						<a href="<?php echo element('listall_url', $view); ?>" class="btn btn-outline btn-secondary ">FAQ 전체목록</a>
						...
						<a href="<?php echo element('write_url', $view); ?>" class="btn btn-outline btn-danger ">FAQ 내용 추가</a>
					</div>
				<?php
