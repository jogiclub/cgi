		...
		?>
			<div class="box-table-header">
				<ul class="nav nav-tabs mb-3">
					<li class="nav-item"><a class="nav-link active" href="<?php echo admin_url($this->pagedir); ?>">배너관리</a></li>
					<li class="nav-item"><a class="nav-link" href="<?php echo admin_url($this->pagedir . '/group'); ?>">배너 위치 관리</a></li>
				</ul>
				<?php
				ob_start();
				?>
				...
				<div class="btn-group btn-group-sm pull-right" role="group">
					<a href="?" class="btn  <?php echo ($this->input->get('ban_activated') !== 'Y' && $this->input->get('ban_activated') !== 'N') ? 'btn-success' : 'btn-secondary'; ?>">전체배너</a>
					<a href="?ban_activated=Y" class="btn  <?php echo ($this->input->get('ban_activated') === 'Y') ? 'btn-success' : 'btn-secondary'; ?>">활성</a>
					<a href="?ban_activated=N" class="btn  <?php echo ($this->input->get('ban_activated') === 'N') ? 'btn-success' : 'btn-secondary'; ?>">비활성</a>
				</div>
			</div>
