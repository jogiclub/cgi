<?php $this->managelayout->add_css(element('view_skin_url', $layout) . '/css/style.css?1'); ?>
	...
	<div class="form-horizontal">
		...
		<div class="input-group">
			<div class="col-sm-9 col-sm-offset-3 mt20">
				<a href="<?php echo site_url('membermodify'); ?>" class="btn btn-secondary btn-sm" title="회원정보 변경">회원정보 변경</a>
			</div>
		</div>
	</div>
</div>
