		...
		<table class="table">
			...
			?>
				<tr>
					...
					<td>
						<button class="btn btn-success btn-scrap-modify" data-scrap-id="<?php echo element('scr_id', $result); ?>" type="button"><span class="bi bi-pencil"></span></button>
					</td>
					<td>
						<button class="btn btn-danger btn-one-delete" type="button" data-one-delete-url = "<?php echo element('delete_url', $result); ?>"><span class="bi bi-trash"></span></button>
					</td>
				</tr>
			<?php
				}
