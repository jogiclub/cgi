...
<div class="board">
    ...
    <h5><div class="card-body"><?php echo element('output', element('0', element('extra_content', $view))); //장소설명 ?></h5>
    <h1 class="mb-3">
    ...
    <div class="card mb-3"><div class="card-body"><?php echo element('output', element('1', element('extra_content', $view))); //주소?></div></div>
    <div class="card mb-3"><div class="card-body"><?php echo element('output', element('2', element('extra_content', $view))); //오시는길 설명?></div></div>
    <div class="card mb-3"><div class="card-body"><?php echo element('output', element('3', element('extra_content', $view))); //URL?></div></div>
