	...
	<div class="table-image">
		...
		?>
			<div class="gallery-box" style="width:<?php echo element('gallery_percent', element('board', element('list', $view))); ?>%;margin-right:<?php echo $marginright;?>%;">
				...
				<a href="<?php echo element('post_url', $result); ?>" title="<?php echo html_escape(element('title', $result)); ?>" style="background: url(<?php echo element('thumb_url', $result); ?>) center center/cover;width:100%;height:<?php echo element('gallery_image_height', element('board', element('list', $view))); ?>px; display: inline-block"></a>
