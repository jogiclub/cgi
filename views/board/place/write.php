...
?>
<?php $this->managelayout->add_css(element('view_skin_url', $layout) . '/css/style.css?' . $version); ?>

<?php echo element('headercontent', element('board', $view)); ?>

<div class="board">
	<h3 class="mb-3"><?php echo html_escape(element('board_name', element('board', $view))); ?> 글쓰기</h3>
	<?php
	...
	?>
		...
		<div class="form-horizontal box-table">
				...
				<div class="col-sm-10" style="display:table;">
					...
					<?php if (element('use_google_map', element('board', $view))) { ?>
						<span class="input-group-btn">
							<button type="button" class="btn btn-md btn-secondary" id="btn_google_map" onClick="open_google_map();">지도</button>
						</span>
					<?php } ?>
				</div>
			</div>
				...
				<div class="input-group">
					...
					<div class="col-sm-10">
						...
						<label class="checkbox-inline" for="post_title_color">
							...
							<button type="button" class="btn btn-xs btn-secondary" id="btn_color_picker" >색상선택</button>
						...
						<div>
							<div class="btn-group  mb10">
								<?php if (element('use_emoticon', element('board', $view))) { ?>
									<button type="button" class="btn btn-secondary btn-sm" onclick="window.open('<?php echo site_url('helptool/emoticon?id=post_content'); ?>', 'emoticon', 'width=600,height=400,scrollbars=yes')"><i class="bi bi-smile-o fa-lg"></i></button>
								<?php } ?>
								<?php if (element('use_specialchars', element('board', $view))) { ?>
									<button type="button" class="btn btn-secondary btn-sm" onclick="window.open('<?php echo site_url('helptool/specialchars?id=post_content'); ?>', 'specialchars', 'width=490,height=245,scrollbars=yes')"><i class="bi bi-star-o fa-lg"></i></button>
								<?php } ?>
								<button type="button" class="btn btn-secondary btn-sm" onClick="resize_textarea('post_content', 'down');"><i class="bi bi-plus fa-lg"></i></button>
								<button type="button" class="btn btn-secondary btn-sm" onClick="resize_textarea('post_content', 'up');"><i class="bi bi-minus fa-lg"></i></button>
							</div>
						</div>
					<?php } ?>
            ...
            <div class="input-group mt-3 justify-content-center">
				<button type="button" class="btn btn-secondary btn-sm btn-history-back">취소</button>
