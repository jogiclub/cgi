<div class="sidebar_latest">
	...
	<ul class="list-group">
		...
		?>
			<li class="list-group-item"><span class="bi bi-chevron-right" style="font-size:0.7em;"></span> <a href="<?php echo site_url('cmall/lists/' . element('cca_id', $value))?>" style="font-weight:bold;" title="<?php echo html_escape(element('cca_value', $value)); ?>"><?php echo html_escape(element('cca_value', $value)); ?></a></li>
				<?php
