...
<?php } else { ?>
	...
	<div class="welcome mb10">
		...
		<ul class="mt20">
			<li><a href="javascript:;" onClick="open_profile('<?php echo $this->member->item('mem_userid'); ?>');" class="btn btn-secondary btn-xs" title="나의 프로필">프로필</a></li>
			<li><a href="<?php echo site_url('mypage'); ?>" class="btn btn-secondary btn-xs" title="마이페이지">마이페이지</a></li>
			<li><a href="<?php echo site_url('mypage/scrap'); ?>" class="btn btn-secondary btn-xs" title="나의 스크랩">스크랩</a></li>
			<li><a href="<?php echo site_url('membermodify'); ?>" class="btn btn-secondary btn-xs" title="정보수정">정보수정</a></li>
			<li><a href="<?php echo site_url('login/logout?url=' . urlencode(current_full_url())); ?>" class="btn btn-secondary btn-xs" title="로그아웃">로그아웃</a></li>
		</ul>
	</div>
	<!-- welcome end -->
